...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_myupload_scss__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_myupload_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__css_myupload_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_details_vue__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_details_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_details_vue__);
...
new __WEBPACK_IMPORTED_MODULE_3_vue___default.a({
    ...
    el: '#myupload-wrapper',
    components: {
        'app-details': __WEBPACK_IMPORTED_MODULE_4__components_details_vue___default.a,
    ...
    data: {
        ...
        localTab: 'tab-upload',
        tabchoosed: true,
        localList: this.allowedApp,
        details: {}
    },
    methods: {
        tab: function tab(n) {
            if (n === 0) {
                this.localTab = 'tab-upload';
                this.localList = this.allowedApp;
            } else if (n === 1) {
                this.localTab = 'tab-audit';
                this.localList = this.auditApp;
            } else {
                this.localTab = 'tab-refuse';
                this.localList = this.refusedApp;
            }
        },
        showDetails: function showDetails(appid, key) {
            var dialog = document.getElementById('dialog'),
                app = document.querySelector('.list'),
            ...
            //     }
            // });
            this.details = this.localList[key];
        },
