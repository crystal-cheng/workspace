...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/appcenter/components/app.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4b8c787d", Component.options)
  } else {
    hotAPI.reload("data-v-4b8c787d", Component.options)
  }
})()}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_index_scss__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_sortablejs__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__global_components_dialog_vue__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__global_components_dialog_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__global_components_dialog_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__global_components_box_vue__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__global_components_box_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__global_components_box_vue__);
/**
 * 应用中心
...
// http request
__WEBPACK_IMPORTED_MODULE_3_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_5_vue_resource__["a" /* default */]);
...
new __WEBPACK_IMPORTED_MODULE_3_vue___default.a({
    ...
    data: {
        ...
        // 推荐图标
        icons: ['home', 'edit', 'chain', 'dollar', 'globe', 'clipboard', 'inbox', 'laptop'],
    ...
    components: {
        ...
        'x-dialog': __WEBPACK_IMPORTED_MODULE_7__global_components_dialog_vue___default.a,
        'x-box': __WEBPACK_IMPORTED_MODULE_8__global_components_box_vue___default.a
    },
    methods: {
        add: function add() {
    ...
    mounted: function mounted() {
        var _this = this;
        var $appList = document.querySelector('.appcenter');
        var center = document.getElementById('apps-center');

        this.sortable = new __WEBPACK_IMPORTED_MODULE_4_sortablejs___default.a(document.getElementById('app-list'), {
            ...
            onUpdate: function onUpdate(e) {
                ...
                var from = e.oldIndex;
                var to = e.newIndex;
                var $from = _this.apps[from];

                _this.apps.splice(from, 1);
                _this.apps.splice(to, 0, $from);
                var apps = _this.apps.map(function (app) {
                    return {
                        id: app.id,
                        order: order++
                    };
                });
                var target = _this.apps[from].id;
        ...
        var single = 315; // width + margin
        var resize = function resize() {
            var width = $appList.offsetWidth;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('li', {
    ...
    style: (_vm.style.appStyle),
    on: {
      "mouseenter": _vm.enter,
      "mouseleave": _vm.leave
    }
  }, [_c('a', {
    staticClass: "main-href",
    attrs: {
      "href": _vm.href
    }
  }, [_c('section', {
    ...
    staticClass: "icon",
    style: (_vm.style.iconCircleStyle)
  }, [_c('i', {
    staticClass: "fa",
    class: _vm.icon,
    style: (_vm.style.iconStyle)
  })]), _vm._v(" "), (_vm.count) ? _c('span', {
    staticClass: "count"
  }, [_vm._v(_vm._s(_vm.count))]) : _vm._e()]), _vm._v(" "), _c('section', {
    staticClass: "bottom"
  }, [_c('div', {
    staticClass: "basic"
  }, [_c('p', {
  ...
  }, [_vm._v(_vm._s(_vm.description))])]), _vm._v(" "), _c('transition', {
    attrs: {
      "name": "slide"
    }
  }, [(_vm.hover) ? _c('div', {
    staticClass: "subs-con"
  }, [_c('a', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-4b8c787d", module.exports)
  }
}
