...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_tinycon__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ellipsis_js__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_perfect_scrollbar__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_box_vue__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_customer__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_perfect_scrollbar_src_css_main_scss__ = __webpack_require__(17);
...
var entIds = ['BaoXianFuWuAnQuanTiJ', 'BaoXianFuWu', 'APICeShiQiYe'];

var default51Buttons = [{
...
var safetyHost = 'tools.51safety.com.cn';
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    computed: {
        is51Safety: function is51Safety() {
            return location.hostname === safetyHost;
        },
        existsIcon: function existsIcon() {
            return _.some(entIds, function (entId) {
                return entId === window.Safirst.user.entId;
            });
        }
    },
    components: {
    ...
    methods: {
        ...
        fetch51Buttons: function fetch51Buttons() {
            var _this2 = this;

            this.$http.get('eai/project/api/user/getUserLevel.do').then(function (response) {
                return response.json();
            }).then(function (result) {
                if (result.data.userLevel === 'ent') {
                    _this2.more51Buttons = default51Buttons;
                    if (!window.sessionStorage.getItem('safetycheck')) {
                        location.href = '/eai/project/safetycheck.do';
                        window.sessionStorage.setItem('safetycheck', true);
                    }
                }
                if (result.data.userLevel === 'org' || result.data.userLevel === 'expert') {
                    if (!window.sessionStorage.getItem('safetycheck')) {
                        location.href = '/professional/npsw/eva#hp';
                        window.sessionStorage.setItem('safetycheck', true);
                    }
                }
                if (result.data.userLevel === 'insurance') {
                    if (!window.sessionStorage.getItem('safetycheck')) {
                        location.href = '/professional/risk/param';
                        window.sessionStorage.setItem('safetycheck', true);
                    }
                }
            });
    ...
    created: function created() {
        ...
        query('body').addEventListener('click', function () {
            _this3.showSkinList = false;
            _this3.showUserSet = false;
        });
...
side = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    components: {
        'x-dialog': __WEBPACK_IMPORTED_MODULE_5__components_box_vue___default.a
    },
    mounted: function mounted() {
    ...
    methods: {
        ...
        // 退出二次确认
        logoutDialog: function logoutDialog() {
            this.dialogbox.show = true;
        },

        // 关闭提示弹框
        dialogEvent: function dialogEvent(cb) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "close iconfont icon-guanbi",
    attrs: {
      "aria-hidden": "true"
    },
    on: {
...
// 高度达最大高度&以...结尾
// 好假 我自己都不信了
var isEllipsis = function isEllipsis($el, height) {
    if ($el) {
...
/* harmony default export */ __webpack_exports__["a"] = (isEllipsis);
...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/global/components/popper.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7fd5b635", Component.options)
  } else {
    hotAPI.reload("data-v-7fd5b635", Component.options)
  }
})()}
...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/organization/components/ucenter/app.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1929c45a", Component.options)
  } else {
    hotAPI.reload("data-v-1929c45a", Component.options)
  }
})()}
...
var on = function on(el, event, handler) {
    if (el && event && handler) {
        document.addEventListener ? el.addEventListener(event, handler, false) : el.attachEvent('on' + event, handler);
    }
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_vue___default.a.nextTick(function (_) {

            var $popper = _this.$refs.popper;

            var $trigger = _this.$slots.reference[0].elm;

            on($trigger, 'mouseover', function (_) {
                var offsetWidth = $trigger.offsetWidth,
            ...
            on($trigger, 'mouseout', function (_) {
                _this.show = false;
            });
        });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_resource__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__left_vue__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__left_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__left_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__middle_vue__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__middle_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__middle_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__right_vue__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__right_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__right_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__u_and_me_vue__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__u_and_me_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__u_and_me_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        left: __WEBPACK_IMPORTED_MODULE_2__left_vue___default.a,
        middle: __WEBPACK_IMPORTED_MODULE_3__middle_vue___default.a,
        right: __WEBPACK_IMPORTED_MODULE_4__right_vue___default.a,
        'u-and-me': __WEBPACK_IMPORTED_MODULE_5__u_and_me_vue___default.a
    },
    created: function created() {
        var _this = this;

        var id = location.pathname.replace(/\/organization\/usercontactinfo\//, '');

        this.$http.get('/organization/usercontactinfo/info/' + id).then(function (response) {
            if (response.ok) {
                var _response$body = response.body,
                    left = _response$body.left,
                    middle = _response$body.middle,
                    right = _response$body.right,
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        var works = {};
        var jobslist = _.clone(this.jobs);
        var isLastOver = _.size(this.works) >= this.workflowCount;
        // init works
        _.forEach(jobslist, function (job) {
            var definition_id = job.definition_id,
    ...
    computed: {
        start: function start() {
            ...
            _.forEach(this.works, function (work, id) {
        ...
        more: function more(appid) {
            ...
            this.$http.get('/organization/job/more', {
                ...
                if (response.ok && response.body.status === 200) {
                    ...
                    _this.works[appid].data = _.concat(_this2.works[appid].data, data);
                }
            });
        },
        lastmore: function lastmore() {
            var _this3 = this;
            ...
            this.$http.get('/organization/job/lastmore', {
                ...
                if (response.ok && response.body.status === 200) {
                    ...
                    _.forEach(_this.jobslist, function (job) {
                        var definition_id = job.definition_id,
                            dataCount = job.dataCount,
                            data = job.data;
                    ...
                    _this.isLastOver = _.size(_this.works) >= _this3.workflowCount;
                }
            });
        }
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            talks: _.slice(this.initTalk, 0, 10) // 首屏10个
        };
    },
        ...
        more: function more() {
            ...
            this.$http.get('/organization/talk/more', {
                ...
                if (response.ok && response.body.status === 200) {
                    ...
                    _this.talks = _.concat(_this.talks, data);
                }
            });
        }
    }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ellipsis_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ellipsis_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_ellipsis_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__global_components_popper_vue__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__global_components_popper_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__global_components_popper_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__is_ellipsis__ = __webpack_require__(38);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        popper: __WEBPACK_IMPORTED_MODULE_2__global_components_popper_vue___default.a
    },
    updated: function updated() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_ellipsis_js___default()({
            lines: LINE,
            class: '.sign-text'
        });

        __WEBPACK_IMPORTED_MODULE_1_vue___default.a.nextTick(function (_) {
            var $sign = _this.$refs.sign;
            if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__is_ellipsis__["a" /* default */])($sign, 20 * LINE)) {
                _this.popDisable = false;
            }
        });
    }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    updated: function updated() {
        ...
        __WEBPACK_IMPORTED_MODULE_1_vue___default.a.nextTick(function (_) {
            var $desc = _this.$refs.desc;
            if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__is_ellipsis__["a" /* default */])($desc, 20 * DESC_LINE)) {
                _this.desPopDisable = false;
            }

            var $addr = _this.$refs.addr;
            if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__is_ellipsis__["a" /* default */])($addr, 20 * ADDR_LINE)) {
                _this.addPopDisable = false;
            }

            var $email = _this.$refs.email;
            if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__is_ellipsis__["a" /* default */])($email, 20 * EMAIL_LINE)) {
                _this.emailPopDisable = false;
            }
        });
    }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        // 上级更多
        toggleChiefs: function toggleChiefs() {
            this.moreChief = !this.moreChief;
        },

        // 下级更多
        toggleJuniors: function toggleJuniors() {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__intersection_job_vue__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__intersection_job_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__intersection_job_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__intersection_talk_vue__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__intersection_talk_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__intersection_talk_vue__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        job: __WEBPACK_IMPORTED_MODULE_0__intersection_job_vue___default.a,
        talk: __WEBPACK_IMPORTED_MODULE_1__intersection_talk_vue___default.a
    },
    methods: {
        tabFocus: function tabFocus(index) {
            this.focus = index;
        }
    },
    created: function created() {
        ...
        // 共同工作
        var workPromise = this.$http.get('/organization/interwork', {
            params: {
                id: id
            }
        });
        ...
        // 互动沟通
        var talkPromise = this.$http.get('/organization/intertalk', {
            params: {
                id: id
            }
        });

        Promise.all([workPromise, talkPromise]).then(function (response) {
            var work = response[0];
            var talk = response[1];

            if (work.ok && work.body.status === 200) {
                var _work$body$result = work.body.result,
                    count = _work$body$result.count,
                    data = _work$body$result.data,
                    workflowCount = _work$body$result.workflowCount;

                _this.works = data;
                _this.worksCount = count || 0;
                _this.workflowCount = workflowCount || 0;
            }

            if (talk.ok && talk.body.status === 200) {
                var _talk$body$result = talk.body.result,
                    _count = _talk$body$result.count,
                    _data = _talk$body$result.data;


                _this.talks = _data;
                _this.talkCount = _count ? +_count : 0;
            }

            // focus第一个显示的tab
            if (_this.worksCount || _this.talkCount) {
                _this.focus = _this.worksCount ? 'WORK' : 'TALK';
            }
        });
    }
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__global_global_scss__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__global_global_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_ucenter_scss__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_ucenter_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__css_ucenter_scss__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_ucenter_app_vue__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_ucenter_app_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__components_ucenter_app_vue__);
/**
 * 用户资料页
...
new __WEBPACK_IMPORTED_MODULE_3_vue___default.a({
  ...
  render: function render(h) {
    return h(__WEBPACK_IMPORTED_MODULE_5__components_ucenter_app_vue___default.a);
  }
});
...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/organization/components/ucenter/intersection-job.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] intersection-job.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b8bcc592", Component.options)
  } else {
    hotAPI.reload("data-v-b8bcc592", Component.options)
  }
})()}
...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/organization/components/ucenter/intersection-talk.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] intersection-talk.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0f11e822", Component.options)
  } else {
    hotAPI.reload("data-v-0f11e822", Component.options)
  }
})()}
...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/organization/components/ucenter/left.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c52b7e76", Component.options)
  } else {
    hotAPI.reload("data-v-c52b7e76", Component.options)
  }
})()}
...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/organization/components/ucenter/middle.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7bcf31d3", Component.options)
  } else {
    hotAPI.reload("data-v-7bcf31d3", Component.options)
  }
})()}
...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/organization/components/ucenter/right.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4d22f1ce", Component.options)
  } else {
    hotAPI.reload("data-v-4d22f1ce", Component.options)
  }
})()}
...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/organization/components/ucenter/u-and-me.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] u-and-me.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b8ce8838", Component.options)
  } else {
    hotAPI.reload("data-v-b8ce8838", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('li', {
      ...
      staticClass: "datetime left"
    }, [_vm._v(_vm._s(talk.time))]), _vm._v(" "), _c('div', {
      staticClass: "info left"
    }, [_c('p', {
      staticClass: "app-name"
    }, [_c('a', {
      attrs: {
        "href": _vm.appLink(talk.appInfo),
        "target": "_blank"
      }
    }, [_vm._v(_vm._s(talk.appTitle))])]), _vm._v(" "), _c('p', {
      staticClass: "content",
      domProps: {
        "innerHTML": _vm._s(_vm.at(talk.msg))
      }
    })])])
  })), _vm._v(" "), _c('p', {
    directives: [{
    ...
    staticClass: "iconfont icon-xiazhankai",
    on: {
      "click": _vm.more
    }
  })])])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-0f11e822", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })], 1), _vm._v(" "), (!_vm.self) ? _c('u-and-me') : _vm._e()], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-1929c45a", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v("岗位信息")]), _vm._v(" "), _c('section', {
    staticClass: "station block"
  }, [_c('p', {
    staticClass: "sub-title"
  }, [_vm._v("岗位名称")]), _vm._v(" "), _c('ul', {
    staticClass: "station-list",
    class: {
      'only': _vm.data.jobs && _vm.data.jobs.length <= 1
    }
  }, _vm._l((_vm.data.jobs), function(job) {
    return _c('li', [_c('i', {
      staticClass: "icon iconfont icon-duoxuanweixuanzhong"
    }), _vm._v("\n                " + _vm._s(job) + "\n            ")])
  }))]), _vm._v(" "), (_vm.data.chiefs) ? _c('section', {
    staticClass: "chief block"
  }, [_c('p', {
    staticClass: "sub-title"
  }, [_vm._v("直接上级")]), _vm._v(" "), (_vm.data.chiefs.length > 0) ? _c('div', [_c('ul', {
    staticClass: "chief-list clearfix"
  }, _vm._l((_vm.data.chiefs), function(chief, index) {
    return _c('li', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: (index >= 16 ? _vm.moreChief : true),
        expression: "index >= 16 ? moreChief : true"
      }],
      attrs: {
        "title": chief.name
      }
      ...
      attrs: {
        "href": ("/organization/usercontactinfo/" + (chief.id))
      }
    }, [_c('img', {
      staticClass: "avatar",
      attrs: {
      ...
      staticClass: "name"
    }, [_vm._v(_vm._s(chief.name))])])])
  })), _vm._v(" "), _c('p', {
    staticClass: "icon-wrap"
  }, [(_vm.data.chiefs.length > 16) ? _c('span', {
    staticClass: "iconfont icon-xiazhankai",
    class: {
      'spread': _vm.moreChief
    },
    on: {
      "click": _vm.toggleChiefs
    }
  }) : _vm._e()])]) : _c('div', {
    staticClass: "no-one"
  }, [_vm._v("\n            暂无直接上级\n        ")])]) : _vm._e(), _vm._v(" "), (_vm.data.juniors) ? _c('section', {
    staticClass: "junior block"
  }, [_c('p', {
    staticClass: "sub-title"
  }, [_vm._v("直接下级")]), _vm._v(" "), (_vm.data.juniors.length > 0) ? _c('div', [_c('ul', {
    staticClass: "junior-list clearfix"
  }, _vm._l((_vm.data.juniors), function(junior, index) {
    return _c('li', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: (index >= 16 ? _vm.moreJunior : true),
        expression: "index >= 16 ? moreJunior : true"
      }],
      attrs: {
        "title": junior.name
      }
      ...
      attrs: {
        "href": ("/organization/usercontactinfo/" + (junior.id))
      }
    }, [_c('img', {
      staticClass: "avatar",
      attrs: {
      ...
      staticClass: "name"
    }, [_vm._v(_vm._s(junior.name))])])])
  })), _vm._v(" "), _c('p', {
    staticClass: "icon-wrap"
  }, [(_vm.data.jobs && _vm.data.juniors.length > 16) ? _c('span', {
    staticClass: "iconfont icon-xiazhankai",
    class: {
      'spread': _vm.moreJunior
    },
    on: {
      "click": _vm.toggleJuniors
    }
  }) : _vm._e()])]) : _c('div', {
    staticClass: "no-one"
  }, [_vm._v("\n            暂无直接下级\n        ")])]) : _vm._e()])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-4d22f1ce", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.qq))])])]), _vm._v(" "), _c('div', {
    staticClass: "row clearfix"
  }, [_c('div', {
    staticClass: "info-item"
  }, [_c('p', {
    staticClass: "label"
  }, [_vm._v("邮箱")]), _vm._v(" "), _c('popper', {
    attrs: {
      "width": _vm.emailPopWidth,
      "disable": _vm.emailPopDisable
    }
  }, [_vm._v("\n                        " + _vm._s(_vm.email) + "\n                        "), _c('p', {
    ref: "email",
    staticClass: "value email-ellipsis",
    attrs: {
      "slot": "reference"
    },
    slot: "reference"
  }, [_vm._v(_vm._s(_vm.email))])])], 1), _vm._v(" "), _c('div', {
    staticClass: "info-item"
  }, [_c('p', {
    staticClass: "label"
  }, [_vm._v("分机号")]), _vm._v(" "), _c('p', {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.ext))])])])])]), _vm._v(" "), _c('section', {
    staticClass: "job block"
  }, [_c('p', {
    staticClass: "title"
  }, [_vm._v("工作信息")]), _vm._v(" "), _c('div', {
    staticClass: "info"
  }, [_c('div', {
    staticClass: "row clearfix"
  }, [_c('div', {
    ...
    staticClass: "label"
  }, [_vm._v("任职年限")]), _vm._v(" "), _c('p', {
    staticClass: "value"
  }, [_vm._v(_vm._s(_vm.ageLimit))])]), _vm._v(" "), _c('div', {
    staticClass: "job-addr info-item"
  }, [_c('p', {
    staticClass: "label"
  }, [_vm._v("地址")]), _vm._v(" "), _c('popper', {
    attrs: {
      "width": _vm.addPopWidth,
      "disable": _vm.addPopDisable
    }
  }, [_vm._v("\n                        " + _vm._s(_vm.addr) + "\n                        "), _c('p', {
    ref: "addr",
    staticClass: "value addr-ellipsis",
    attrs: {
      "slot": "reference"
    },
    slot: "reference"
  }, [_vm._v(_vm._s(_vm.addr))])])], 1)]), _vm._v(" "), _c('div', {
    staticClass: "job-des info-item"
  }, [_c('p', {
    staticClass: "label"
  }, [_vm._v("分工描述")]), _vm._v(" "), _c('popper', {
    attrs: {
      "width": _vm.desPopWidth,
      "disable": _vm.desPopDisable
    }
  }, [_vm._v("\n                    " + _vm._s(_vm.jobdesc) + "\n                    "), _c('p', {
    ref: "desc",
    staticClass: "value des-ellipsis",
    attrs: {
      "slot": "reference"
    },
    slot: "reference"
  }, [_vm._v(_vm._s(_vm.jobdesc))])])], 1)])])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-7bcf31d3", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "x-popper"
  }, [_c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (!_vm.disable && _vm.show),
      expression: "!disable && show"
    }],
    ref: "popper",
    staticClass: "popper",
    style: ({
  ...
  }, [_vm._t("default")], 2), _vm._v(" "), _vm._t("reference")], 2)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-7fd5b635", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('ul', {
    staticClass: "intersection-job"
  }, _vm._l((_vm.jobslist), function(job, mainindex) {
    return _c('li', {
      staticClass: "clearfix"
    }, [_c('p', {
      staticClass: "app-name left"
    }, [_vm._v(_vm._s(job.definition_title))]), _vm._v(" "), _c('ul', {
      staticClass: "sub left"
    }, _vm._l((_vm.works[job.definition_id].data), function(data, index) {
      return _c('li', {
        staticClass: "clearfix"
      }, [_c('p', {
        staticClass: "update-time left"
      }, [_vm._v("\n                        " + _vm._s(data.updated_at) + "\n                        "), _c('span', {
        staticClass: "update-create-text right"
      }, [_vm._v("更新")])]), _vm._v(" "), _c('p', {
        staticClass: "title left"
      }, [_c('a', {
        attrs: {
          "href": ("/app/!/workflow/open/record/" + (job.definition_id) + "/" + (data.instance_id)),
          "target": "_blank"
        }
      }, [_vm._v(_vm._s(data.title))])]), _vm._v(" "), _c('p', {
        staticClass: "create-time right"
      }, [_vm._v("\n                        " + _vm._s(data.created_at) + "\n                        "), _c('span', {
        staticClass: "update-create-text"
      }, [_vm._v("创建")])])])
    })), _vm._v(" "), _c('p', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: (!_vm.isOver[job.definition_id]),
        expression: "!isOver[job.definition_id]"
      }],
      staticClass: "icon"
    }, [_c('span', {
      staticClass: "iconfont icon-xiazhankai",
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (!_vm.isLastOver),
      expression: "!isLastOver"
    }],
    staticClass: "icon"
  }, [_c('span', {
    staticClass: "iconfont icon-xiazhankai",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-b8bcc592", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "um-outside"
  }, [(_vm.show) ? _c('div', {
    staticClass: "u-and-me"
  }, [_c('ul', {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.worksCount),
      expression: "worksCount"
    }],
    staticClass: "tab",
    class: {
      'focus': _vm.focus === 'WORK'
    },
    on: {
      "click": function($event) {
        _vm.tabFocus('WORK')
  ...
  }, [_vm._v("\n                共同工作 (" + _vm._s(_vm.worksCount) + "条)\n            ")]), _vm._v(" "), _c('li', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.talkCount),
      expression: "talkCount"
    }],
    staticClass: "tab",
    class: {
      'focus': _vm.focus === 'TALK'
    },
    on: {
      "click": function($event) {
        _vm.tabFocus('TALK')
  ...
  }, [_vm._v("\n                互动沟通 (" + _vm._s(_vm.talkCount) + "条)\n            ")])]), _vm._v(" "), _c('div', {
    staticClass: "contents"
  }, [(_vm.focus === 'WORK') ? _c('job', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.worksCount),
    ...
    attrs: {
      "jobs": _vm.works,
      "workflowCount": _vm.workflowCount,
      "id": _vm.id
    }
  }) : _vm._e(), _vm._v(" "), (_vm.focus === 'TALK') ? _c('talk', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.talkCount),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-b8ce8838", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "title": _vm.data.real_name
    }
  }, [_vm._v(_vm._s(_vm.data.real_name))]), _vm._v(" "), (_vm.data.sex !== undefined) ? _c('span', {
    staticClass: "iconfont",
    class: _vm.data.sex === 1 ? 'icon-nv' : 'icon-MAN'
  }) : _vm._e()]), _vm._v(" "), _c('p', {
    staticClass: "spell-name"
  }, [_vm._v("\n            " + _vm._s(_vm.data.pinying) + "\n        ")])]), _vm._v(" "), _c('div', {
    staticClass: "signature"
  }, [_c('popper', {
    attrs: {
      "width": _vm.popWidth
    }
  }, [_vm._v("\n            " + _vm._s(_vm.data.sign || '暂无签名') + "\n            "), _c('p', {
    ref: "sign",
    staticClass: "sign-text",
    attrs: {
      "slot": "reference"
    },
    slot: "reference"
  }, [_vm._v(_vm._s(_vm.data.sign || '暂无签名'))])])], 1), _vm._v(" "), _c('div', {
    ...
    staticClass: "count"
  }, [_vm._v(_vm._s(_vm.data.intimacyNum || 0))]), _vm._v(" "), _vm._m(0)]), _vm._v(" "), _c('div', {
    ...
    staticClass: "count"
  }, [_vm._v(_vm._s(_vm.data.workNum || 0))]), _vm._v(" 条\n            "), _c('span', {
    staticClass: "mark"
  }, [_vm._v("共同工作")])]), _vm._v(" "), _c('p', {
    staticClass: "talk"
  }, [_c('span', {
    staticClass: "count"
  }, [_vm._v(_vm._s(_vm.data.communicateNum || 0))]), _vm._v(" 条\n            "), _c('span', {
    staticClass: "mark"
  }, [_vm._v("互动沟通")])])]), _vm._v(" "), _c('a', {
    staticClass: "back",
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-c52b7e76", module.exports)
  }
}
