...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/appstore/components/progressBar.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9da9b0e0", Component.options)
  } else {
    hotAPI.reload("data-v-9da9b0e0", Component.options)
  }
})()}
...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/global/components/fileupload.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-56d26a86", Component.options)
  } else {
    hotAPI.reload("data-v-56d26a86", Component.options)
  }
})()}
...
Component.options.__file = "/home/anyuan/workspace/Node-SaaS/public/source/global/components/vue-select.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] vue-select.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f28c37a8", Component.options)
  } else {
    hotAPI.reload("data-v-f28c37a8", Component.options)
  }
})()}
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_resource__["a" /* default */]);
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_2_element_ui__["Progress"]);
 ...
 *  selectOptions
 *      type: array
 *      value: [{id: string, text: string, label: string(分组名称，没有分组不写)}]
 *
 *  allowClear
 *      type: boolean
 *      value: false/true(多选为true)
 *
 *  multiple
 *      type: boolean　
 *      value: false/true(单选不需要)
 *
 *  placeholder
 *      type: string
 *
 *  ajax
 *      type: object 需要http请求
 *      value: {
 *                  url: 'api/xxx' string
 *                  data: {
 *                       page: 1, number
 ...
 *                   },
 *                   results: function　
 *                        return {more: boolean, result: {id: string, text: string, label: 分组名称，没有分组不写}}
 *             }
 *
**/
...
__WEBPACK_IMPORTED_MODULE_2_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_resource__["a" /* default */]);
/* harmony default export */ __webpack_exports__["default"] = ({
    props: {
        selectOptions: {
            type: Array,
    ...
    methods: {
        ...
        parseOptions: function parseOptions(options) {
            if (options.length) {
                options = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(options, function (option) {
        ...
        //保持active
        keepActive: function keepActive(index) {
        ...
        prev: function prev() {
            ...
            var itemHeight = droplist.getElementsByClassName('dropdown-item')[0].offsetHeight;
            if (droplist.scrollTop > 0) {
                droplist.scrollTop = droplist.scrollTop - itemHeight;
            }
        },
        next: function next() {
            if (this.actvieIndex < this.unselectedOptions.length - 1) {
                this.actvieIndex += 1;
            }
            var droplist = this.$refs.droplist;
            var itemHeight = droplist.getElementsByClassName('dropdown-item')[0].offsetHeight;
        ...
        add: function add(index) {
            this.addSelected(this.unselectedOptions[index]);
            this.blur();
        },
        ...
        addSelected: function addSelected(option) {
            ...
            this.$emit('input', this.getselectedOptionsId(this.selectedOptions));
        },

        //获取选中的选项的id
        getselectedOptionsId: function getselectedOptionsId(selectedOptions) {
            var selectedOptns = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(selectedOptions);
            if (this.multiple) {
                return selectedOptns;
            } else {
                return selectedOptns[0];
            }
        },

        //删除已已选中的
        deleteSelect: function deleteSelect(option) {
            this.selectedOptions = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.difference(this.selectedOptions, [option]);
            this.$emit('input', this.getselectedOptionsId(this.selectedOptions));
        },

        //搜索过滤
        searchItem: function searchItem(option) {
            if (this.search) {
                return option.text.indexOf(this.search) > -1;
            } else {
                return true;
            }
        },
        ...
        //查看过滤后的选项的length
        checkAllItem: function checkAllItem(usOptions) {
            var _this2 = this;

            var usList = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(usOptions);
            usList = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.filter(usList, function (list) {
                return _this2.searchItem(list);
            });
            return !usList.length;
        },
        checkLabel: function checkLabel(usOptions, optgroupName) {
            var _this3 = this;

            var usList = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.cloneDeep(usOptions);
            usList = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.filter(usList, function (list) {
                return list.label === optgroupName;
            });
            usList = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.filter(usList, function (item) {
                return _this3.searchItem(item);
            });
            return usList.length;
        },
        ...
        searchOptions: function searchOptions(event) {
            if (this.ajax && !__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.includes([40, 38, 13], event.keyCode)) {
                this.getOptions();
            }
        },
        ...
        getOptions: function getOptions() {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.isEmpty(this.ajax)) {
                if (this.ajax.data) {
                    this.ajax.data = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.assign(this.ajax.data, { name: this.search,
                        prePage: (this.ajax.data.page - 1) * this.ajax.data.limit });
                }
                if (this.ajax.url) {
                    this.$http.get(this.ajax.url, {
                        params: this.ajax.data
                    }).then(function (response) {
                        var result = _this4.ajax.results(response.body, _this4.ajax.data.page);
                        _this4.options = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.unionBy(_this4.options, result.result, 'id');
                        _this4.more = result.more;
                    });
                }
            }
        },

        //多选focus清除placeholder
        clearPlaceholder: function clearPlaceholder() {
            this.isClearPlh = false;
        },

        //设置默认值
        setValue: function setValue() {
            if (this.value) {
                this.selectedOptions = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.isArray(this.value) ? this.parseOptions(this.value) : this.parseOptions([this.value]);
            } else {
    ...
    watch: {
        selectOptions: function selectOptions() {
            this.options = this.parseOptions(this.selectOptions);
        },
    ...
    computed: {
        unselectedOptions: function unselectedOptions() {
            return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.differenceBy(this.options, this.selectedOptions, 'id');
        },
        optgroup: function optgroup() {
            var group = [];
            if (this.options.length && typeof this.options[0].label !== 'undefined') {
                group = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(this.options, function (option) {
                    return option.label;
                });
                group = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.uniq(group);
            }
            return group;
        }
    },
    ...
    mounted: function mounted() {
        var droplist = this.$refs.droplist;
        var me = this;
        droplist.addEventListener('scroll', function () {
            var isBottom = this.scrollHeight - this.scrollTop >= this.offsetHeight;
            if (me.more && isBottom) {
                me.ajax.data.page = me.ajax.data.page + 1;
                me.getOptions();
            }
        });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_upload_scss__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_upload_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__css_upload_scss__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__global_components_dialog_vue__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__global_components_dialog_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__global_components_dialog_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__global_components_vue_select_vue__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__global_components_vue_select_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__global_components_vue_select_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__global_components_fileupload_vue__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__global_components_fileupload_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__global_components_fileupload_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_progressBar_vue__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_progressBar_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__components_progressBar_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_vee_validate__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_vee_validate_dist_locale_zh_CN__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_vee_validate_dist_locale_zh_CN___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_vee_validate_dist_locale_zh_CN__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_axios__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_element_ui__ = __webpack_require__(25);
...
__WEBPACK_IMPORTED_MODULE_3_vue___default.a.prototype.$ajax = __WEBPACK_IMPORTED_MODULE_11_axios___default.a;

// import {Dialog, Button, Checkbox, CheckboxGroup, Upload, Select, Option, Message} from 'element-ui';
// Vue.use(Dialog);
// Vue.use(Button);
// Vue.use(Checkbox);
...
__WEBPACK_IMPORTED_MODULE_3_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_12_element_ui___default.a);

__WEBPACK_IMPORTED_MODULE_3_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_4_vue_resource__["a" /* default */]);
__WEBPACK_IMPORTED_MODULE_9_vee_validate__["a" /* Validator */].addLocale(__WEBPACK_IMPORTED_MODULE_10_vee_validate_dist_locale_zh_CN___default.a);
var config = {
...
__WEBPACK_IMPORTED_MODULE_9_vee_validate__["a" /* Validator */].extend('versionV', {
    messages: {
        'zh-CN': function zhCN(field) {
            return '版本号格式错误，只支持字母、数字和小数点';
        }
    },
...
__WEBPACK_IMPORTED_MODULE_3_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_9_vee_validate__["b" /* default */], config);
...
new __WEBPACK_IMPORTED_MODULE_3_vue___default.a({
    ...
    components: {
        'vue-select': __WEBPACK_IMPORTED_MODULE_6__global_components_vue_select_vue___default.a,
        'file-upload': __WEBPACK_IMPORTED_MODULE_7__global_components_fileupload_vue___default.a,
        'x-dialog': __WEBPACK_IMPORTED_MODULE_5__global_components_dialog_vue___default.a,
        'progress-bar': __WEBPACK_IMPORTED_MODULE_8__components_progressBar_vue___default.a
    },
    data: {
        industry: [

            // {id: 1, text: '办公'}, {id: 2, text: 'IT'},
            // {id: 3, text: '物资'}, {id: 4, text: '金融'},
            // {id: 5, text: '体育'}
        ],
        selectIndustry: null,
        category: [
        ...
        selectCategory: null,
        type: 1, // 应用类型 1-应用，2-系统
        appname: '', // 应用的名称
        icon: '', // 应用选择的图标
        industryId: 1, // 选中的行业类别id
        categoryId: 1, // 选中的应用类别id
        images: [], // 上传的图片
        imgeUpload: 'icon-xiangji',
        relationApp: [{ id: 1, text: '客户信息' }, { id: 2, text: '项目信息' }, { id: 3, text: '出差计划' }, { id: 4, text: '项目计划' }],
        version: '',
        dialog: { // 添加图标
            title: null,
            mask: true,
        ...
        color: ['#a094ed', '#7e8be4', '#00cdc0', '#62b7ed', '#fe8f60', '#696e71', '#1fcaa0', '#8199af', '#54698d', '#6ca1e9', '#ef6e64', '#ef7eac', '#7dc37d', '#fcb95b'],
        iconColor: '#a094ed', // 默认图标颜色为第一个
    ...
    methods: {
        ...
        showDialog: function showDialog() {
            var dialog = document.getElementById('dialog'),
                ...
                left = addicon.offsetLeft + 'px',
                top = addicon.offsetTop + 'px';

            dialog.style.position = 'absolute';
            dialog.style.left = left;
            dialog.style.top = top;
            dialog.style.width = '630px';
            dialog.style.height = '352px';
            this.dialog.show = true;
        },

        // 应用打包上传
        appUpload: function appUpload() {
            var _this = this;
            ...
            this.$validator.validateAll().then(function (result) {
                if (result) {
                    ...
                    //     _this.$http.get('progress').then(response => {
        ...
        beforeImgUpload: function beforeImgUpload(file) {
            var isImage = file.type === 'image/png' || file.type === 'img/jpg' || file.type === 'image/jpeg';
        ...
        addBorder: function addBorder(key) {
            this.iconColor = this.color[key];
        }
    },
    mounted: function mounted() {},
    watch: {},
    created: function created() {
        var id = location.pathname.replace(/\/appstore\/upload\//, ''),
            _this = this,
            fileio = location.origin.replace(/www/, 'fileio');

        this.uploadUrl = fileio + '/api2/app/admin/image/upload';
        this.$http.get('items').then(function (response) {
            if (response.ok && response.status === 200) {
                _this.industry = response.body.industry;
                _this.category = response.body.categories;
            }
        });
        this.$http.get('verison').then(function (response) {
            if (response.ok && response.status === 200) {
                _this.version = response.body;
            }
        });
    }
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.button) ? _c('section', {
    staticClass: "fileupload-section"
  }, [_c('button', {
    staticClass: "fileupload-button"
  }, [_c('i', {
    staticClass: "iconfont",
    class: _vm.icon
  }), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.text))])]), _vm._v(" "), _c('input', {
    staticClass: "fileupload-input",
    attrs: {
      "type": "file",
      "name": "fileUpload",
    ...
    staticClass: "fileupload-link"
  }, [_c('div', {
    staticClass: "fileupload-a"
  }, [_vm._v("\n        " + _vm._s(_vm.text) + "\n        "), _c('input', {
    staticClass: "fileupload-input",
    attrs: {
      "type": "file",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-56d26a86", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._m(0), _vm._v(" "), _c('el-progress', {
    attrs: {
      "text-inside": false,
      "stroke-width": 18,
      "percentage": 70,
  ...
  return _c('div', {
    staticClass: "clearfix progress-text"
  }, [_c('span', {
    staticClass: "text"
  }, [_vm._v("软件包上传中，请您耐心等待...")]), _vm._v(" "), _c('span', {
    staticClass: "percent"
  }, [_vm._v("70%")])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-9da9b0e0", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    class: {
      'vue-select-dropdown': _vm.dropdown, 'vue-select-multiple': _vm.multiple
    }
  }, [_c('div', {
    ...
    staticClass: "arrow-icon fa",
    class: [_vm.dropdown ? 'fa-sort-asc ' : 'fa-sort-desc']
  })]) : _vm._e(), _vm._v(" "), _c('span', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.placeholder && !_vm.selectedOptions.length && _vm.isClearPlh),
      expression: "placeholder && !selectedOptions.length && isClearPlh"
    }],
    staticClass: "select-placeholder"
  }, [_vm._v("\n            --" + _vm._s(_vm.placeholder) + "--\n        ")]), _vm._v(" "), _vm._l((_vm.selectedOptions), function(select) {
    return _c('span', {
      staticClass: "selected-tag"
    }, [_vm._v("\n            " + _vm._s(select.text) + "\n            "), (_vm.allowClear) ? _c('span', {
      staticClass: "select-delete-icon",
      on: {
        "click": function($event) {
          $event.stopPropagation();
          _vm.deleteSelect(select)
        }
      }
    }, [_c('i', {
    ...
    on: {
      "blur": _vm.blur,
      "focus": _vm.clearPlaceholder,
      "keyup": [_vm.searchOptions, function($event) {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (!_vm.unselectedOptions.length || _vm.checkAllItem(_vm.unselectedOptions)),
      expression: "!unselectedOptions.length || checkAllItem(unselectedOptions)"
    }],
    staticClass: "dropdown-no-search"
  }, [_c('span', [_vm._v("没有找到匹配项")])]), _vm._v(" "), (!_vm.optgroup.length) ? _c('li', [_c('ul', _vm._l((_vm.unselectedOptions), function(option, index) {
    return _c('li', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: (_vm.searchItem(option)),
        expression: "searchItem(option)"
      }],
      staticClass: "dropdown-item",
      class: {
        'dropdown-list-active': _vm.dropdown && index === _vm.actvieIndex
      },
      on: {
        "click": function($event) {
          $event.stopPropagation();
          _vm.addSelected(option)
        },
        "mouseover": function($event) {
          _vm.keepActive(index)
        }
      }
    }, [_c('span', {
      attrs: {
  ...
  }))]) : _vm._l((_vm.optgroup), function(groupName) {
    return _c('li', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: (_vm.checkLabel(_vm.unselectedOptions, groupName)),
        expression: "checkLabel(unselectedOptions, groupName)"
      }],
      staticClass: "dropdown-optgroup"
    }, [_c('span', {
      staticClass: "dropdown-label"
    }, [_vm._v(_vm._s(groupName))]), _vm._v(" "), _c('ul', _vm._l((_vm.unselectedOptions), function(option, index) {
      return _c('li', {
        directives: [{
          name: "show",
          rawName: "v-show",
          value: (_vm.searchItem(option) && option.label === groupName),
          expression: "searchItem(option) && option.label === groupName"
        }],
        staticClass: "dropdown-item",
        class: {
          'dropdown-list-active': _vm.dropdown && index === _vm.actvieIndex
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-f28c37a8", module.exports)
  }
}
