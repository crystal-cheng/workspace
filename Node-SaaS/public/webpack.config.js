...
const domain = require('../config').static;
...
const config = {
    ...
    output: {
        filename: PRO_ENV ? '[name].[chunkhash].js' : '[name].js',
    ...
    plugins: [
        new ExtractTextPlugin({
            filename: PRO_ENV ? '[name].[chunkhash].css' : '[name].css',
            disable: false,
            allChunks: true
        }),
        new webpack.optimize.CommonsChunkPlugin({
            name: 'lib',
            filename: PRO_ENV ? 'lib.[hash].js' : 'lib.js',
